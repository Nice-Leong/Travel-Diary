...
exports.publishDiary = async (req, res) => {
    try {
      const { title, content, images, video, location, departure_time, days, cost, partner, user_id } = req.body;
      ...
      const insertId = await publishModel.createDiary({ title, content, images, video, location, departure_time, days, cost, partner, user_id });
